...
<head>
  ...
  <!-- bootstrap core css -->
  <link rel="stylesheet" type="text/css" href="/newwebiste/css/bootstrap.css" />

  <!-- fonts style -->
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,700|Poppins:400,600,700&display=swap" rel="stylesheet" />

  <!-- Custom styles for this template -->
  <link href="/newwebiste/css/style.css" rel="stylesheet" />
  <!-- responsive style -->
  <link href="/newwebiste/css/responsive.css" rel="stylesheet" />
</head>
...
<body>
  <div class="hero_area">
    ...
    <div class="hero_bg_box">
      <div class="img-box">
        <img src="/newwebiste/images/hero-bg.jpg" alt="">
      </div>
    </div>
              ...
              <div class="row">
                <div class="col-md-7">
                  <div class="detail-box">
                    ...
                    <p>
                     Investing in Future Trades: Unlocking Profits and Commissions for Sustainable Growth
                    </p>
                    <div class="btn-box">
                      <a href="https://psxweb.pakistanstockexchangeinvesters.com" class="btn-1"> Login </a>
                      <a href="{{App\Models\Setting::where('key','android_app_url')->get()->first()->value}}" class="btn-2">DownloadApp</a>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="row">
        <div class="col-md-6 px-0">
          <div class="img_container">
            <div class="img-box">
              <img src="/newwebiste/images/client.jpg" alt="" />
            </div>
          </div>
        </div>
        <div class="col-md-6 px-0">
          <div class="detail-box">
            ...
            <p>
               In today’s rapidly evolving market, investing in future trades has become one of the most effective strategies to generate both profits and commissions. Whether you're a seasoned trader or just starting, the future is where the real opportunities lie.
            </p>
            <div class="btn-box">
              <a href="">
                Read More
        ...
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
               Future trades allow you to capitalize on emerging trends before they allows ther are fully unfold.
              </p>
              <a href="">
                Read More
              </a>
        ...
        <div class="col-md-4">
          ...
          c10.095-0.01,18.276-8.191,18.286-18.286V283.429C475.419,273.334,467.238,265.153,457.143,265.143z" />
            ...
            <div class="detail-box">
              ...
              <p>
               It offers a chance to diversify your portfolio and mitigate risks by hedging against market fluctuations              </p>
              <a href="">
                Read More
              </a>
            </div>
        ...
        <div class="col-md-4">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
               With the right strategies, you can amplify your returns—whether through margin trading or options contracts.
              </p>
              <a href="">
                Read More
              </a>
      ...
      <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="box">
              <div class="img-box">
                <img src="/newwebiste/images/client.png" alt="">
              </div>
              <div class="detail-box">
                <h4>
                  Minim Veniam
  ...
  <section class="contact_section layout_padding" id="contact">
    <div class="contact_bg_box">
      <div class="img-box">
        <img src="/newwebiste/images/contact-bg.jpg" alt="">
      </div>
    </div>
    <div class="container">
      <div class="heading_container heading_center">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6 mx-auto ">
          <div class="box">
            <div class="img-box">
              <img src="/newwebiste/images/t1.jpg" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Martin Anderson
        ...
        <div class="col-md-4 col-sm-6 mx-auto ">
          <div class="box">
            <div class="img-box">
              <img src="/newwebiste/images/t2.jpg" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Denny Butler
        ...
        <div class="col-md-4 col-sm-6 mx-auto ">
          <div class="box">
            <div class="img-box">
              <img src="/newwebiste/images/t3.jpg" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Nathan Mcpherson
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="info_logo">
            ...
            <p>
               When you invest in futures, you’re positioning yourself for long-term rewards. The market moves fast, and those who stay ahead are the ones who reap the benefits.
            </p>
          </div>
        </div>
        <div class="col-md-3">
  ...
  <script src="/newwebiste/js/jquery-3.4.1.min.js"></script>
  <script src="/newwebiste/js/bootstrap.js"></script>
  <script src="/newwebiste/js/custom.js"></script>
</body>
