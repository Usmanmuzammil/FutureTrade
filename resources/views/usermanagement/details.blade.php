...
<script type="text/javascript">
    $(function() {
     ...
     var table = $('#deposit_request_table').DataTable({
         processing: true,
         serverSide: true,
         ajax: "/admin/user/details/depositrequest/" + userId,
         columns: [
             { data: 'id', name: 'id' },
             { data: 'user', name: 'user' },
             { data: 'bank', name: 'bank' },
 ...
 $(function() {
    var userId = {{ $user->id }};
     var table = $('#transaction_history_table').DataTable({
         processing: true,
         serverSide: true,
         ajax: "/admin/user/details/transactiontable/" + userId,
         columns: [
             { data: 'id', name: 'id' },
             { data: 'user', name: 'user' },
             { data: 'type', name: 'type' },
 ...
 $(function() {
    var userId = {{ $user->id }};
     var table = $('#investment_table').DataTable({
         processing: true,
         serverSide: true,
         ajax: "/admin/user/details/trade/" + userId,
         columns: [
             { data: 'id', name: 'id' },
             { data: 'user', name: 'user' },
  ...
  $(function() {
    var userId = {{ $user->id }};
     var table = $('#withdraw_request_table').DataTable({
         processing: true,
         serverSide: true,
         ajax: "/admin/user/details/withdrawrequest/" + userId,
         columns: [ 
             { data: 'id', name: 'id' },
             { data: 'user', name: 'user' },
             { data: 'bank', name: 'bank' },
