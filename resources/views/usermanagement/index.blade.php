...
{{-- <td>PKR {{ $user->user_available_amount()['User_Avaiable_Amount'] }}</td> --}}
         ...
         columns: [
             ...
             { 
                 ...
                 render: function(data, type, full, meta) {
                     return '<a href="https://futuretrade.website/invite?id=' + data + '">https://futuretrade.website/invite?id= '+ data +'</a>';
                 }
             },
